...
const ForgotPassword = () => {
  ...
  const handleReset = async (e) => {
    ...
    try {
      ...
      // 🔥 Firebase reset email with redirect
      await sendPasswordResetEmail(auth, email, {
        url: "http://localhost:3000", // redirect after reset
      });
    ...
    bg-gradient-to-br from-[#0f172a] via-[#1e3a8a] to-[#7c3aed]">
      ...
      hover:shadow-cyan-400/20 transition">
        ...
        <div className="text-center mb-6">
          ...
          <div className="w-16 h-[2px] bg-gradient-to-r
          from-cyan-400 to-purple-400 mx-auto mt-2"></div>
        </div>
