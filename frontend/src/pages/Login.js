...
export default function Login() {
  ...
  return (
    <div
      className="min-h-screen flex flex-wrap items-center justify-center md:justify-between gap-8 px-6 md:px-20 py-10
    ...
    >
      ...
      <div className="w-full md:w-[45%] flex justify-center md:justify-start">
        <div
          className="bg-[#0b1220]/80 backdrop-blur-xl border border-white/10
      ...
      <div className="w-full md:w-[45%] flex justify-center md:justify-end">
        <div
          className="bg-[#0b1220]/90 backdrop-blur-xl border border-white/10
        ...
        >
          ...
          <div className="mb-4">
            ...
            <div
              className="flex items-center bg-[#1f2937] rounded-lg border border-gray-600
